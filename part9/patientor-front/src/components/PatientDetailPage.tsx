  ...
  const handleAddEntry = async (
    ...
    switch (values.type) {
      case "Hospital":
        entryData = {
          ...values,
          discharge: (values as HospitalFormValues).discharge,
        } as Entry;
        break;
      case "OccupationalHealthcare":
        entryData = {
          ...values,
          employerName: (values as OccupationalHealthcareFormValues).employerName,
          sickLeave: (values as OccupationalHealthcareFormValues).sickLeave,
        } as Entry;
        break;
      case "HealthCheck":
        entryData = {
          ...values,
          healthCheckRating: (values as HealthCheckEntryFormValues).healthCheckRating,
        } as Entry;
        break;
      default:
        throw new Error(`Unknown entry type: ${values.type}`);
